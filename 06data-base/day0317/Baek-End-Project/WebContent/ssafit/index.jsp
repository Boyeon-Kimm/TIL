...
<body id="page-top">
	...
	<header class="masthead">
		<div class="container">
			...
			<a 	 href="#services" class="btn btn-primary btn-xl text-uppercase">View More</a>
		</div>
	</header>
	<!-- 인기 영상 TOP3 -->
      ...
      <div class="row content-video-list">
        <c:forEach items="${videolist }" var="video">
          <div class="portfolio-item">
            <a class="portfolio-link" href="main?act=videodetail&videoId=${video.youtubeId }">   
            <div class="portfolio-hover">
              <div class="portfolio-hover-content"><i class="fas fa-plus fa-3x"></i></div>
            </div>
            <img class="img-fluid" src="https://img.youtube.com/vi/${video.youtubeId }/0.jpg" alt="..." />
            
            </a>
            <div class="portfolio-caption">
              <div class="portfolio-caption-subheading text-muted">${video.fitPartName }</div>
            <div class="portfolio-caption-heading">${video.title}</div>
            <div class="item-intro">영상 조회 수 : ${video.viewCnt}</div>
            <div class="portfolio-caption-subheading text-muted">${video.channelName }</div>
	...
	<section class="page-section bg-light" id="team">
		<div class="container">
			<div class="text-center">
				<h2 class="s	ection-heading text-uppercase">Our Amazing Team</h2>
				<h3 class="section-subheading text-muted">Team 소희보연</h3>
			</div>
			<div class="row">
				<div class="col-lg-4">
